...
Alternatively, if you are working exclusively in Python or R, using their built-in package management systems helps ensure that your workflow is portable, easy to share, and reproducible long-term. 

* [Conda Environments](./conda)
* [Software Package/Environment Management for Python](./python)
* [Software Package/Environment Management in R](./r)
