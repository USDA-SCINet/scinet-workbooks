...
{% include alert class="question" title="Your turn!" content="What are the dimensions of `I_camera_rgb`?  How many channels does it have?  What is the variable type?  What are the max and min values?" %}
